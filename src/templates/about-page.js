      ...
      <div className="container">
        ...
        <div id="team">
          <div className="title-container margin-bottom-2">
            <div className="f-arnopro-b subtitle-h4">THE EDCELLENT TEAM</div>
            <div className="title-horizontal-line"></div>
          </div>
          <div id="carlyn">
            <div className="photo-container">
              <img src="/img/Carlyn-Formal.jpg" alt="carlyn-photo"/>
            ...
            <div className="text-container">
              ...
              <div className="f-arnopro-r text-md-md margin-bottom-1">Founder of Edcellent Education</div>
              <div className="ethos">
                <p className="text-small">As parents, teachers and students, how often do we ask ourselves these questions:</p><br /> 
                <p className="f-arnopro-i">
                  <strong>Why</strong> am I doing what I am doing? <br/>
                  <strong>How</strong> often do we find joy in what we do? <br/>
          ...
          <div id="cameron">
            <div className="photo-container">
              <img src="/img/Cameron-Formal.jpg" alt="cameron-photo"/>
            </div>
            <div className="text-container">
              <div className="f-arnopro-b text-medium">Cameron Sievers</div>
              <div className="f-arnopro-r text-medium-small margin-bottom-1">Senior English Coordinator at Edcellent Education
              </div>
              <p className="text-small justified">
